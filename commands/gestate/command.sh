...
echo
echo "koad:io 2016-2026 © koad.sh"
...
GNUPGHOME=$DATADIR/keyring

# Trust Chain — set TRUST_CHAIN to your signing entity's trust directory
# TRUST_CHAIN=\$HOME/.juno/trust

# Git Configuration
GIT_AUTHOR_NAME=$ENTITY
GIT_AUTHOR_EMAIL=${ENTITY}@${ENTITY_DOMAIN}

"> $DATADIR/.env
echo "wrote minimum .env: $DATADIR/.env"
pause 1

echo "Running koad-io init to register entity wrapper command: $ENTITY"
koad-io init $ENTITY --forceful
pause 1
