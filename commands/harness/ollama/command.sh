...
# harness/ollama — local inference via ollama
#
# A lightweight harness for quick inference against a local ollama instance.
# No identity, no tools, no session context — just prompt in, text out.
#
# Usage:
#   koad-io harness ollama "your prompt"
#   koad-io harness ollama -m deepseek "your prompt"
