...
This is a fork and continuation of the cultofcoders:persistent-session package.
...
This package is a fork and continuation of the excellent work by:
* Original: [okgrow/meteor-persistent-session](https://github.com/okgrow/meteor-persistent-session)
* Previous maintainer: [cultofcoders/meteor-persistent-session](https://github.com/cult-of-coders/meteor-persistent-session)
