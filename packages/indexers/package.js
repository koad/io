...
Package.onUse(function(api) {
	...
	//  18. projects — VESTA-SPEC-192; sets globalThis.ProjectsCollection; must load before goals
	//  19. goals — VESTA-SPEC-192; sets globalThis.GoalsCollection; depends on Projects for counts
	api.addFiles([
		...
		'server/indexers/repo-scanner.js',
		'server/indexers/projects.js',
		'server/indexers/goals.js',
	], 'server');
